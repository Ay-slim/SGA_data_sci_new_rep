...
ggplot(mtcars, aes(x=factor(mtcars$am), y=mpg)) + geom_boxplot()
ggplot(mtcars, aes(x=factor(mtcars$am), y=disp)) + geom_boxplot()
ggplot(mtcars, aes(x=factor(mtcars$am), y=hp)) + geom_boxplot()
ggplot(mtcars, aes(x=factor(mtcars$am), y=drat)) + geom_boxplot()
ggplot(mtcars, aes(x=factor(mtcars$am), y=wt)) + geom_boxplot()
ggplot(mtcars, aes(x=factor(mtcars$am), y=qsec)) + geom_boxplot()

ggplot(mtcars, aes(x=factor(mtcars$cyl), y=mpg)) + geom_boxplot()
ggplot(mtcars, aes(x=factor(mtcars$cyl), y=disp)) + geom_boxplot()
ggplot(mtcars, aes(x=factor(mtcars$cyl), y=hp)) + geom_boxplot()
ggplot(mtcars, aes(x=factor(mtcars$cyl), y=drat)) + geom_boxplot()
ggplot(mtcars, aes(x=factor(mtcars$cyl), y=wt)) + geom_boxplot()
ggplot(mtcars, aes(x=factor(mtcars$cyl), y=qsec)) + geom_boxplot()

ggplot(mtcars, aes(x=factor(mtcars$carb), y=mpg)) + geom_boxplot()
ggplot(mtcars, aes(x=factor(mtcars$carb), y=disp)) + geom_boxplot()
ggplot(mtcars, aes(x=factor(mtcars$carb), y=hp)) + geom_boxplot()
ggplot(mtcars, aes(x=factor(mtcars$carb), y=drat)) + geom_boxplot()
ggplot(mtcars, aes(x=factor(mtcars$carb), y=wt)) + geom_boxplot()
ggplot(mtcars, aes(x=factor(mtcars$carb), y=qsec)) + geom_boxplot()

ggplot(mtcars, aes(x=factor(mtcars$gear), y=mpg)) + geom_boxplot()
ggplot(mtcars, aes(x=factor(mtcars$gear), y=disp)) + geom_boxplot()
ggplot(mtcars, aes(x=factor(mtcars$gear), y=hp)) + geom_boxplot()
ggplot(mtcars, aes(x=factor(mtcars$gear), y=drat)) + geom_boxplot()
ggplot(mtcars, aes(x=factor(mtcars$gear), y=wt)) + geom_boxplot()
ggplot(mtcars, aes(x=factor(mtcars$gear), y=qsec)) + geom_boxplot()
### Scatter plot
